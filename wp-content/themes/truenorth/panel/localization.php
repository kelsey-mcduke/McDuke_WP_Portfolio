...
function ci_localize_datepicker() {
	...
	$translations = apply_filters('ci_datepicker_translation', array(
		'langCode'        => $lang,
		'prevText'        => __( 'Previous', 'truenorth' ),
		'nextText'        => __( 'Next', 'truenorth' ),
		'closeText'       => __( 'Close', 'truenorth' ),
		'currentText'     => __( 'Today', 'truenorth' ),
		...
		'isRTL'           => 'rtl' === $wp_locale->text_direction ? true : false,
	));
